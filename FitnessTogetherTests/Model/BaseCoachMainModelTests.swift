...
final class BaseCoachMainModelTests: XCTestCase {
    ...
    func test_DataToItem() {
        ...
        var workout = FTWorkout(id: "workoutId", startDate: Date())
    ...
    func test_GetItems_WorkoutOutOfDate() {
        let client = FTUser(firstName: "Client", role: .client, id: "ClientId")
        var coach = FTUser(firstName: "Coach", role: .coach, id: "CoachId")
        ...
        var workout = FTWorkout(id: "workoutId", startDate: Date().addingTimeInterval(-8 * 24 * 60 * 60))
    ...
    func test_GetItems_CoachHasClientRolt() {
        let client = FTUser(firstName: "Client", role: .client, id: "ClientId")
        var coach = FTUser(firstName: "Coach", role: .coach, id: "CoachId")
    ...
    func test_GetItems_WorkoutSorting() {
        ...
        var workout1 = FTWorkout(id: "workoutId1", startDate: date)
        ...
        workout2.startDate = date.addingTimeInterval(-1)
